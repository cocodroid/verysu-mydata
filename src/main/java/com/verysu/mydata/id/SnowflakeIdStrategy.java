 ...
 */
public class SnowflakeIdStrategy extends AbstractIdStrategy{
	...
	private static SnowflakeIdStrategy flowIdWorker = new SnowflakeIdStrategy(1);

	public static SnowflakeIdStrategy getFlowIdWorkerInstance() {
		return flowIdWorker;
	}
    ...
    public static void main(String[] args) throws Exception {
		...
		SnowflakeIdStrategy idWorker = SnowflakeIdStrategy.getFlowIdWorkerInstance();
		// System.out.println(Long.toBinaryString(idWorker.nextId()));
		System.out.println(idWorker.nextId());
		System.out.println(idWorker.nextId());
		//1503327013728 1504195200000 22 1 12 0
//        timestamp - this.epoch << this.timestampLeftShift | this.workerId << this.workerIdShift | this.sequence
//        System.out.println(1503327013728L-1504195200000L);
    }
